...
const U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<section>${arrayofgames ? `${name ? `<div class="${"akd svelte-94uyur"}"><h1 class="${"svelte-94uyur"}">${escape(name)}&#39;s Profile
</h1>

<div class="${"buttons svelte-94uyur"}"><button id="${"backlog"}" type="${"button"}" class="${"btn btn-primary"}" disabled>Profile</button>
...
<div class="${"games svelte-94uyur"}">${``}</div>` : `<h1 class="${"svelte-94uyur"}">Loading...</h1>`}` : `<h1 class="${"svelte-94uyur"}">User not found</h1>`}
