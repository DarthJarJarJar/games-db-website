...
var Navbar_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".form-stuff.svelte-1szcraw{margin:16px}#buttonsubmit.svelte-1szcraw{margin-top:16px;margin-bottom:16px}#usernamesearch.svelte-1szcraw{width:10rem}")();
const css = {
  code: ".form-stuff.svelte-1szcraw{margin:16px}#buttonsubmit.svelte-1szcraw{margin-top:16px;margin-bottom:16px}#usernamesearch.svelte-1szcraw{width:10rem}",
  map: null
};
      ...
      <div class="${"collapse navbar-collapse"}" id="${"navbarSupportedContent"}"><ul class="${"navbar-nav me-auto mb-2 mb-lg-0"}"><li class="${"nav-item"}"><a class="${"nav-link active"}" aria-current="${"page"}" href="${"/"}">Home</a></li>
          ...
          <li class="${"nav-item dropdown"}">
            ...
            <ul class="${"dropdown-menu"}" aria-labelledby="${"navbarDropdown"}"><li><h6 class="${"dropdown-header"}">Search users</h6></li>
              ...
              <div class="${"form-stuff svelte-1szcraw"}"><div class="${"form-group"}"><label for="${"exampleDropdownFormEmail1"}">Username</label>
                  <input class="${"form-control svelte-1szcraw"}" id="${"usernamesearch"}" autocomplete="${"off"}"${add_attribute("value", searchedUser, 0)}></div>
                
                <div class="${"form-group"}"><a${add_attribute("href", `/user/home/${searchedUser.toLowerCase()}`, 0)} rel="${"external"}"><button type="${"submit"}" class="${"btn btn-primary svelte-1szcraw"}" id="${"buttonsubmit"}">Search</button></a></div></div>
            </ul></li></ul>
