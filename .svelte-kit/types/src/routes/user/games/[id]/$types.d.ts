...
export type PageData = Omit<import('../../../$types.js').LayoutData, keyof Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/user/games/[id]/+page.js').load>>>> & Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/user/games/[id]/+page.js').load>>>;
