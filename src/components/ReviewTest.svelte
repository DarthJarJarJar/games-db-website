   ...
   {/if}
                   ...
                   <div class="form-floating">
                     ...
                     <details open={review ? true : false}>
                        ...
                        <textarea  bind:value={review} class="form-control" placeholder="Write your review" id="floatingTextarea2" style="height: 150px"></textarea>
                   ...
                   {:else} 
                   <StarRating rating={parseFloat(ratingNum)} {config}></StarRating>
                     {#if !review}
