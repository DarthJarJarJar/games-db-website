<script>
    ...
    import { getFirestore,collection, addDoc, setDoc, doc, query, getDocs } from "firebase/firestore"; 
...
<div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input id = "emailInput" type="email" class="form-control" aria-describedby="emailHelp">
        {#if title != "Login"}
        <div id="emailHelp" class="form-text">Your email will be visible to me. Consider using a throwaway email address since there's no verification.</div>
        {/if}
    </div>
    <div class="mb-3">
